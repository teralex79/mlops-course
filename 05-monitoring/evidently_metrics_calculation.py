...
def calculate_metrics_postgresql(curr, i):
	...
	curr.execute(
		"insert into dummy_metrics(timestamp, quantile_value, prediction_drift, num_drifted_columns, share_missing_values) values (%s, %s, %s, %s, %s)",
		(begin + datetime.timedelta(i), quantile_value, prediction_drift, num_drifted_columns, share_missing_values)
	)
